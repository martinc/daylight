...
public extension JulianDate {
    ...
    public func sunriseUTC(location: CLLocationCoordinate2D, solarElevation: Float64) -> Float64 {
        ...
        var hourAngle = hourAngleOfSunrise(latitude: location.latitude, solarDeclination: declination, solarElevation: solarElevation)
        ...
        hourAngle = hourAngleOfSunrise(latitude: location.latitude, solarDeclination: declination, solarElevation: solarElevation)
...
public extension Date {
    ...
    public func calculateDawnAt(_ location: CLLocationCoordinate2D, solarElevation: Float64, timezone: TimeZone) -> Date {
...
func refractiveCorrection(solarElevation: Float64) -> Float64 {
    if solarElevation == 0 { return 0.833 }
    else { return -solarElevation }
}
